...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
        ...
        const slides = [
            { title: "Ethereal Glow", description: "A soft, radiant light that illuminates the soul.", media: "https://images.unsplash.com/photo-1517462964091-a2c071a69841?q=80&w=2069&auto=format&fit=crop" },
            { title: "Rose Mirage", description: "Lost in a desert of blooming dreams and endless horizons.", media: "https://images.unsplash.com/photo-1541963463532-d68292c34b19?q=80&w=1976&auto=format&fit=crop" },
            ...
            { title: "Golden Hour", description: "That fleeting moment when the world is dipped in gold.", media: "https://images.unsplash.com/photo-1477414348463-c0eb7f1359b6?q=80&w=2070&auto=format&fit=crop" },
            { title: "Midnight Dreams", description: "Where reality fades and imagination takes flight.", media: "https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=2094&auto=format&fit=crop" },
            { title: "Silver Light", description: "A cool, metallic shimmer reflecting the urban pulse.", media: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?q=80&w=2070&auto=format&fit=crop" }
        ];
